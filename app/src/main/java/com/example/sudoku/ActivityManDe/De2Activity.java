...
public class De2Activity extends AppCompatActivity {
    LinearLayout ln_top,ln_icon,ln_num;
    TableLayout tbl;
    TextView tv_start,tv_er,tv_time;
    TextView[][] dsView;
    TextView[] dsNum;
    ImageView imgXoa,imgCheck;
    TimerTask timerTask;
    Timer timer;
    Double time = 0.0;
    Boolean ketqua = true;
            ...
            public void onClick(View v) {
                ...
                if (ketqua==true){
                    ...
                    if (name == null) {
                        ...
                        if (kiLucDAO.addKiLucDe2(kiLuc)>0){
                    ...
                    Play.dialog_ht(De2Activity.this);
    ...
    void check(){
        int k = 0; int h = 0;
        while (k<6&&h<6){
            if (!dsView[k][h].getText().equals(Val.de_2[k][h])){
        ...
        for (int i=0;i<6;i++){
            for (int j = 0;j<6;j++){
                if (!dsView[i][j].getText().equals(Val.de_2[i][j])){
                    ketqua = false;
                    break;
                }
                else ketqua = true;
