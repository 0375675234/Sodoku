...
public class De6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_de6);
            ...
            public void onClick(View v) {
                ...
                if (ketqua==true){
                    ...
                    if (name == null) {
                        ...
                        if (kiLucDAO.addKiLucDe6(kiLuc)>0){
                    ...
                    Play.dialog_ht(De6Activity.this);
    ...
    void check(){
        int k = 0; int h = 0;
        while (k<6&&h<6){
            if (!dsView[k][h].getText().equals(Val.de_6[k][h])){
        ...
        for (int i=0;i<6;i++){
            for (int j = 0;j<6;j++){
                if (!dsView[i][j].getText().equals(Val.de_6[i][j])){
                    ketqua = false;
                    break;
                }
                else ketqua = true;
