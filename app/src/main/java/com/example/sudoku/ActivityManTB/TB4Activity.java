...
public class TB4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_t_b4);
            ...
            public void onClick(View v) {
                ...
                if (ketqua==true){
                    ...
                    if (name == null) {
                        ...
                        if (kiLucDAO.addKiLucTB4(kiLuc)>0){
                    ...
                    Play.dialog_ht(TB4Activity.this);
    ...
    void check(){
        int k = 0; int h = 0;
        while (k<9&&h<9){
            if (!dsView[k][h].getText().equals(Val.TB_4[k][h])){
        ...
        for (int i=0;i<9;i++){
            for (int j = 0;j<9;j++){
                if (!dsView[i][j].getText().equals(Val.TB_4[i][j])){
                    ketqua = false;
                    break;
                }
                else ketqua = true;
