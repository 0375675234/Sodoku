...
public class Kho2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kho2);
        ...
        imgCheck.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ketqua==true){
                    ...
                    Play.dialog_ht(Kho2Activity.this);
    ...
    void check(){
        int k = 0; int h = 0;
        while (k<9&&h<9){
            if (!dsView[k][h].getText().equals(Val.Kho_2[k][h])){
        ...
        for (int i=0;i<9;i++){
            for (int j = 0;j<9;j++){
                if (!dsView[i][j].getText().equals(Val.Kho_2[i][j])){
                    ketqua = false;
                    break;
                }
                else ketqua = true;
